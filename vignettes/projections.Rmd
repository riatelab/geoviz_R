...
These projection methods assume a spherical model of the Earth, rather than an ellipsoidal one. In other words, the Earth is treated as a perfect sphere, which simplifies the mathematical transformations required to project geographic coordinates (longitude and latitude) onto a 2D plane.
