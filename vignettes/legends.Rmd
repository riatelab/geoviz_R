...
In `geovizr`, a legend is automatically displayed as soon as you use tthe following thematic mapping functions: `viz_prop()`, `viz_choro()`, `viz_typo()`, `viz_propchoro()`, `viz_proptypo()`, `viz_picto()`, `viz_gridprop()`, `viz_gridchoro()`, `viz_smooth()` and `viz_dotdensity()`.
