...
viz_path(data = roads, stroke = "#38896F", strokeDasharray = 3, strokeWidth = 2) |>
...
``` r
viz_create(projection  = "EqualEarth") |>
viz_path(data = world, simplify = 0.001, rewind = T, rewindPole = T, fill = "#38896F") |>
viz_render()
```
...
``` r
viz_create(projection  = "EqualEarth", zoomable = T) |>
viz_choro(data = world, var = "gdppc", simplify = c(1, 0.05), fill = "#38896F") |>
viz_render()
```
