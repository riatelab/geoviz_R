...
specific layers and overlay them to create the map of your choice. We
list them below.
...
The `viz_path` function allows you to display any basemap (points,
lines, and polygons). You can customize the display using SVG parameters
such as `fill`, `stroke`, `strokeWidth`, `opacity`, `fillOpacity`, and
[many others](https://riatelab.github.io/geoviz/global.html#path).
...
such as `fill`, `stroke`, `strokeWidth`, `opacity`, `fillOpacity`, and
[many others](https://riatelab.github.io/geoviz/global.html#outline).
...
others](https://riatelab.github.io/geoviz/global.html#graticule).
...
`"SR_50M"`. See Other parameters
[here](https://riatelab.github.io/geoviz/global.html#earth).
...
`"hillshade"`, `"worldocean"`, `"natgeo"` or `"worldterrain"`. See Other
parameters [here](https://riatelab.github.io/geoviz/global.html#tile).
...
to create a layer with labels from a spatial dataframe. See all
parameters [here](https://riatelab.github.io/geoviz/global.html#text).
...
others](https://riatelab.github.io/geoviz/global.html#header).
...
`fill`, `fill_background`, `textAnchor`, `dominantBaseline` and [many
others](https://riatelab.github.io/geoviz/global.html#footer).
...
top-left corner). See all parameters
...
allows you to position the scalebar. See all parameters
[here](https://riatelab.github.io/geoviz/global.html#scalebar).
